...
class cart(val id:String, val productName:String, val productPrice:String, val productImage:Int, val productType:String, val productMerk:String, val productDesc:String) :
    Parcelable {
